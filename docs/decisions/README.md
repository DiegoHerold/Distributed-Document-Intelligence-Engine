...
As decisoes do Eixo sao registradas como ADRs.

## ADRs iniciais

- [ADR-0001 - Arquitetura modular](adr-0001-modular-architecture.md)
- [ADR-0002 - API e biblioteca desde o inicio](adr-0002-api-and-library-from-the-start.md)
- [ADR-0003 - Modelo documental canonico](adr-0003-canonical-document-model.md)
- [ADR-0004 - Processamento adaptativo](adr-0004-adaptive-processing.md)
